...
export type OnboardingPath = '/journal' | '/entries' | '/roots';
...
const PATHS: PathOption[] = [
  {
    route: '/journal',
    title: 'Keep writing',
    body: 'Return to your journal and plant another thought.',
    icon: (
 ...
 * second step, then Yggi dissolves into the app shell. All three destinations
 * are ordinary app routes; onboarding is already complete by the time they land.
 * Cards warm their border to gold/30 on hover (the quiet DS hover, no lift).
 */
export function ThreePaths({ onChoose, disabled = false }: ThreePathsProps) {
  return (
